#---
#  title: "Application Qian 2001 method on Cheng-Vogel 2016 data"
#author: "s_morimoto"
#date: "2017/11/25"
#output: 
#  pdf_document: 
...
dataPath_trc     <- "inline-supplementary-material-2.xlsx"
#'Fournier_20151018_trc.xlsx'
#"Gene2011_testResult_ana.xlsx" # 
dataPath_prt     <- "inline-supplementary-material-2.xlsx"
...
allOutput.prefix <- 'Cheng_Vogel_2016_rep2'
...
file_save.image     <- 'Cheng_Vogel.RData'
...
raw_data.trc <- read_excel(
  ...
  mutate(val=2**log_val, var=factor(var,levels=cols)) %>%
  rename(
    id=Gene)
