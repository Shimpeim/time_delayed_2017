#R --vanilla --quiet < simu.permtest_test_20160817_args.R --args  500 10000 ENSG00000111057_ENSG00000186831_ENSG00000099812 Cheng_Vogel_2016_rep_mean_all_Cheng_Vogel_rep_PC07_.RData batch_1  > Simulation_permtest_20160817_1.log 2>&1 &
...
c_sampleSize       <- 500#c_args[1]
c_itt_of_permute   <- 10000#c_args[2]
c_id.select        <- "ENSG00000111057_ENSG00000186831_ENSG00000099812"#c_args[3] # FMT : geneName1_geneName2_ ...
c_makedataData     <- "Cheng_Vogel_2016_rep_mean_all_Cheng_Vogel_rep_PC07_.RData"#c_args[4]
c_outdat_surfix    <- "batch_1"#c_args[5]
